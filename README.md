...
| Module | Status | Notes |
|---|---|---|
| Identity (signup/login/sessions) | IMPLEMENTED | Argon2id passwords, opaque revocable sessions, self-service profile update + password change (revokes other sessions, not the current one) |
