...
| Rate limiting | IMPLEMENTED | `/auth/login` (5/5min/IP), `/auth/signup` (3/hour/IP), `/ai/chat` (60/min/org); in-process by default, or Redis-backed and shared across instances when `NODERA_REDIS_URL` is set; other endpoints remain unlimited |
